...
export default function HistoryArtifactsProof() {
  ...
  const meta = SSOT.pages['/verify-jvto/history-artifacts'];
  ...
  return (
    <div className="min-h-screen bg-audit-white text-jvto-navy font-sans selection:bg-jvto-orange/30 pb-24 md:pb-0">
      ...
      <div className="container mx-auto px-6 py-24 max-w-6xl relative z-10">
        <PageSEO route="/verify-jvto/history-artifacts" />
        ...
        >
          ...
          <p className="text-2xl text-slate-500 max-w-3xl leading-tight font-light">
            Our legacy is built on years of field experience and documented milestones. Explore the artifacts that define our journey.
          </p>
        </motion.div>
        ...
        <div className="space-y-32">
          ...
          >
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {SSOT.proof_vault.history.map((item, i) => (
                <div 
                  key={i}
