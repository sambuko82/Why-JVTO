      ...
      <div className="container mx-auto px-6 py-24 max-w-6xl relative z-10">
        ...
        >
          <div className="flex items-center gap-2 mb-6">
            <ShieldPlus className="w-4 h-4 text-jvto-orange" />
          ...
          >
            <div className="flex items-center justify-between mb-12">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-3xl font-black text-jvto-navy uppercase leading-none mb-1">Police Coordination</h2>
          ...
          >
            <div className="flex items-center justify-between mb-12">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-3xl font-black text-jvto-navy uppercase leading-none mb-1">Safety Equipment</h2>
        ...
        <div className="mt-32 pt-12 border-t border-slate-200 flex flex-col items-center">
          <div className="p-12 bg-white border-4 border-jvto-orange rounded-[2.5rem] -rotate-2 shadow-2xl relative overflow-hidden group hover:rotate-0 transition-transform">
            ...
            <div className="flex flex-col items-center">
              <Siren className="w-20 h-20 text-jvto-orange mb-8" />
              <span className="text-5xl font-black text-jvto-navy uppercase tracking-tighter leading-none mb-3">SECURITY_VERIFIED</span>
