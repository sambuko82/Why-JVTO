      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-24 max-w-6xl relative z-10">
        ...
        >
          <div className="flex items-center gap-2 mb-4 md:mb-6">
            <GraduationCap className="w-3.5 h-3.5 md:w-4 md:h-4 text-jvto-orange" />
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8 mb-16 md:mb-24">
          {benefits.map((benefit, index) => (
            <div key={index} className="bento-card bg-white p-6 md:p-8 flex flex-col group hover:border-jvto-orange transition-all">
              <div className="p-3 md:p-4 bg-slate-50 rounded-lg md:rounded-xl text-slate-500 group-hover:text-jvto-orange transition-colors w-fit mb-6">
                <benefit.icon className="w-6 h-6 md:w-8 md:h-8" />
              </div>
              <h3 className="text-xl md:text-2xl font-black text-jvto-navy uppercase tracking-tight mb-2">{benefit.title}</h3>
        ...
        <div className="mb-16 md:mb-24">
          <h2 className="text-2xl md:text-3xl font-black text-jvto-navy uppercase leading-none mb-8 md:mb-12">How to Claim</h2>
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative bento-card bg-white p-6 md:p-8">
                ...
                <h3 className="text-lg md:text-xl font-black text-jvto-navy uppercase tracking-tight mb-2">{step.title}</h3>
        ...
        <motion.div 
          ...
          className="bento-card bg-jvto-navy text-white p-8 md:p-12 relative overflow-hidden group mb-16 md:mb-24"
        >
          <div className="absolute top-0 right-0 w-64 h-64 bg-jvto-orange/10 rounded-full blur-3xl -mr-32 -mt-32"></div>
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-jvto-orange/10 rounded-full blur-3xl -ml-32 -mb-32"></div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
            <div className="max-w-xl text-center md:text-left">
              ...
              <a 
                ...
                className="inline-flex items-center gap-3 text-jvto-orange font-mono text-[11px] md:text-xs font-bold uppercase tracking-widest hover:text-orange-400 transition-colors"
              >
