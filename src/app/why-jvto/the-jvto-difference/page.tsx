      ...
      <div className="container mx-auto px-6 py-24 max-w-5xl relative z-10">
        ...
        >
          <div className="flex items-center gap-2 mb-6">
            <Zap className="w-4 h-4 text-jvto-orange" />
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-32">
          <div className="bento-card bg-surface-page p-10 border-2 border-slate-100">
            <Target className="w-10 h-10 text-jvto-orange mb-6" />
          ...
          <div className="bento-card bg-surface-page p-10 border-2 border-slate-100">
            <Users className="w-10 h-10 text-jvto-orange mb-6" />
          ...
          <div className="bento-card bg-surface-page p-10 border-2 border-slate-100">
            <Layers className="w-10 h-10 text-jvto-orange mb-6" />
        ...
        {/* Comparison Section */}
        <div className="mt-32">
          <h2 className="text-4xl font-black uppercase mb-12 text-center">The Industry Standard vs. <span className="text-jvto-orange">JVTO</span></h2>
          <div className="grid md:grid-cols-2 gap-px bg-slate-200 rounded-[2rem] overflow-hidden border-2 border-slate-200 shadow-2xl">
            <div className="bg-surface-page p-12">
            ...
            <div className="bg-jvto-navy p-12 text-white">
              <h4 className="font-mono text-[11px] text-jvto-orange uppercase tracking-widest mb-8">JVTO Protocol</h4>
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-start gap-4">
                    <CheckCircle2 className="w-5 h-5 text-jvto-orange shrink-0" />
        ...
        <div className="mt-32 text-center">
          ...
          <button 
            ...
            className="bg-jvto-orange text-white px-12 py-6 rounded-2xl font-black uppercase tracking-widest hover:scale-105 transition-all shadow-2xl shadow-jvto-orange/20"
          >
