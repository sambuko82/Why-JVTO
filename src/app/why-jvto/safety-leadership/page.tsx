      ...
      <div className="container mx-auto px-6 py-24 max-w-5xl relative z-10">
        ...
        >
          <div className="flex items-center gap-2 mb-6">
            <Shield className="w-4 h-4 text-jvto-orange" />
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-32">
              ...
              <ul className="space-y-4 mb-12">
                {SSOT.police_authority.features.map((feature, i) => (
                  <li key={i} className="flex items-center gap-3 text-sm font-mono uppercase tracking-widest text-slate-300">
                    <Radio className="w-4 h-4 text-jvto-orange" /> {feature}
                  </li>
                ))}
              </ul>
              <button 
          ...
          <div className="space-y-8">
            <div className="bento-card bg-surface-page p-10 border-2 border-slate-100">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded-xl bg-jvto-lime/5 text-jvto-lime flex items-center justify-center border border-jvto-lime/10">
        ...
        <div className="mb-32">
          <div className="flex items-center gap-2 mb-12">
            <Stethoscope className="w-4 h-4 text-jvto-orange" />
            <h2 className="text-3xl font-black uppercase">Medical Screening Protocol</h2>
          </div>
          
          <div className="grid md:grid-cols-4 gap-6">
            {SSOT.health_protocol.steps.map((step, i) => (
              <div key={i} className="bento-card bg-surface-page p-8 border-2 border-slate-100 relative">
          ...
          <div className="mt-12 p-12 bg-jvto-lime/5 border-2 border-jvto-lime/10 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-md">
              <h3 className="text-2xl font-black text-jvto-navy uppercase mb-4">The "Hard Stop" Policy</h3>
            ...
            <button 
              ...
              className="bg-jvto-lime text-white px-10 py-5 rounded-xl font-black uppercase tracking-widest hover:scale-105 transition-all shadow-xl shadow-jvto-lime/20 flex items-center gap-3"
            >
