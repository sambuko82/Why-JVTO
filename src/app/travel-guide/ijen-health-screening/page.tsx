    ...
    <div className="min-h-screen bg-surface-page text-jvto-navy font-sans selection:bg-jvto-orange/30 pb-24 md:pb-0">
      ...
      <div className="container mx-auto px-6 py-12 md:py-24 max-w-6xl relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-9xl font-black text-jvto-navy mb-6 md:mb-8 leading-[0.85] uppercase tracking-tighter">
        ...
        <section className="mb-24 md:mb-32">
          <div className="flex items-center gap-2 mb-8 md:mb-12 justify-center">
            <Timer className="w-4 h-4 text-jvto-orange" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 relative">
            ...
            {proceduralFlow.map((step, idx) => (
              <motion.div 
                ...
                className={`relative z-10 bento-card p-8 md:p-10 text-center transition-all duration-500 group ${activeStep === idx ? 'bg-jvto-navy text-white md:scale-105 shadow-2xl' : 'bg-surface-page'}`}
              >
                <div className={`w-16 h-16 md:w-20 md:h-20 rounded-[1.5rem] md:rounded-[2rem] mx-auto mb-6 md:mb-8 flex items-center justify-center transition-all duration-500 ${activeStep === idx ? 'bg-jvto-orange text-white' : 'bg-slate-50 text-slate-500'}`}>
                  {step.icon}
                </div>
                <div className={`font-mono text-[10px] md:text-[11px] uppercase tracking-widest mb-3 md:mb-4 ${activeStep === idx ? 'text-jvto-orange' : 'text-slate-500'}`}>Step 0{idx + 1}</div>
        ...
        <section className="mb-24 md:mb-32">
          <div className="bento-card bg-surface-page p-0 overflow-hidden shadow-2xl border-slate-200">
            <div className="grid grid-cols-1 lg:grid-cols-5">
              
              {/* Left: Doctor Profile */}
              <div className="lg:col-span-2 bg-jvto-navy p-8 md:p-12 flex flex-col justify-center relative overflow-hidden">
                <div className="scanline"></div>
                <div className="relative z-10">
                  <div className="w-16 h-16 md:w-24 md:h-24 bg-white/10 rounded-2xl md:rounded-3xl flex items-center justify-center mb-6 md:mb-8 text-jvto-lime border border-white/10 backdrop-blur-sm">
                  ...
                  <p className="text-jvto-lime font-black text-base md:text-lg uppercase tracking-widest mb-8 md:mb-12">{SSOT.medical.doctor.affiliation}</p>
                  ...
                  <div className="space-y-6 md:space-y-8">
                    ...
                    <a 
                      ...
                      className="group inline-flex items-center gap-3 text-[10px] md:text-[11px] font-black text-jvto-lime uppercase tracking-widest hover:text-white transition-colors"
                    >
              ...
              {/* Right: The Protocol */}
              <div className="lg:col-span-3 p-8 md:p-16 bg-surface-page relative">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 md:mb-12 relative z-10 gap-4">
                  <h3 className="text-2xl md:text-3xl font-black text-jvto-navy uppercase tracking-tighter flex items-center gap-3 md:gap-4">
                    <Activity className="w-6 h-6 md:w-8 md:h-8 text-jvto-orange" />
                ...
                <div className="space-y-8 md:space-y-12 relative z-10">
                  {parameters.map((param, i) => (
                    <div key={i} className="flex flex-col md:flex-row gap-4 md:gap-8 group">
                      ...
                      <div>
                        <h4 className="text-jvto-navy font-black text-xl md:text-2xl uppercase leading-none mb-2 md:mb-3">{param.title}</h4>
        ...
        >
          <div className="text-center mb-12 md:mb-16">
            <div className="badge-eyebrow bg-jvto-lime/10 border border-jvto-lime/30 text-jvto-lime mb-4 md:mb-6">
              <QrCode className="w-4 h-4" /> Digital Health Ledger
            </div>
            <h2 className="text-3xl md:text-5xl font-black text-jvto-navy uppercase mb-4 md:mb-6 tracking-tighter">Fit-to-Climb Certificate</h2>
          ...
          <div className="bento-card bg-surface-page p-6 md:p-16 shadow-2xl border-slate-200 relative overflow-hidden">
            <div className="scanline"></div>
            {/* Watermark */}
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row justify-between items-start border-b-2 md:border-b-4 border-jvto-navy pb-8 md:pb-12 mb-8 md:mb-12 gap-6 md:gap-8">
                <div>
                ...
                <div className="text-left md:text-right w-full md:w-auto">
                  ...
                  <div className="font-mono font-black text-xl md:text-3xl text-jvto-navy bg-slate-50 px-4 md:px-8 py-2 md:py-4 rounded-xl md:rounded-2xl border border-slate-100 shadow-inner inline-block">JVTO-MED-2026-X92</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 mb-8 md:mb-16">
                <div>
                  ...
                  <div className="text-3xl md:text-5xl font-black text-jvto-navy uppercase tracking-tighter">Sarah Jenkins</div>
                </div>
                <div>
                  ...
                  <div className="font-mono text-xl md:text-2xl font-bold text-jvto-navy border-b border-slate-100 pb-2">October 12, 2026</div>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 md:gap-12">
                <div className="w-full md:w-auto">
                  ...
                  <div className="text-xl md:text-3xl font-black text-jvto-navy uppercase border-b-2 md:border-b-4 border-jvto-navy pb-2 md:pb-3 mb-2 md:mb-3 inline-block w-full md:min-w-[350px]">
                ...
                <div className="text-left md:text-right w-full md:w-auto">
                  <div className="verified-badge bg-gradient-to-r from-jvto-lime to-jvto-lime text-jvto-navy px-6 md:px-10 py-3 md:py-5 text-sm md:text-lg shadow-2xl inline-block">Medically Cleared</div>
                </div>
              </div>
            </div>
          </div>
