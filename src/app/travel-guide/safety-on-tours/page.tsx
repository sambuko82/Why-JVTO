      ...
      <div className="container mx-auto px-6 py-12 md:py-24 max-w-4xl relative z-10">
          ...
          {data.sections.map((section, index) => (
            <section key={index}>
              <div className="flex items-center gap-4 mb-6 md:mb-8">
                <div className="p-2.5 md:p-3 bg-slate-50 rounded-2xl text-jvto-orange border border-slate-100">
        ...
        <div className="mt-24 md:mt-32 pt-12 border-t border-slate-100 flex flex-col items-center">
          <div className="p-6 md:p-8 bento-card bg-audit-white border border-slate-200 rounded-3xl flex flex-col items-center">
            <ShieldCheck className="w-10 h-10 md:w-12 md:h-12 text-jvto-orange mb-4" />
            <span className="text-xl md:text-2xl font-black text-jvto-navy uppercase tracking-tighter leading-none mb-2">SAFETY_VERIFIED</span>
