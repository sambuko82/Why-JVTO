      ...
      <div className="container-authority py-16 md:py-32 relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-9xl font-black text-jvto-navy mb-10 leading-[0.85] uppercase tracking-tighter">
            VERIFIED <br />
            <span className="text-jvto-orange">EXPEDITIONS.</span>
          </h1>
          ...
          {tours.map((tour, idx) => (
            ...
            >
              <div className="aspect-[4/3] relative overflow-hidden">
                ...
                {tour.crewName && (
                  <div className="absolute bottom-6 left-6 bg-white text-jvto-navy text-[10px] px-4 py-2 rounded-xl font-black uppercase tracking-[0.1em] shadow-2xl border border-white/20">
                    {tour.crewName}
                  </div>
                )}
              </div>
              <div className="p-10 flex flex-col flex-grow">
                <h3 className="text-2xl font-black text-jvto-navy uppercase tracking-tight mb-4 group-hover:text-jvto-orange transition-colors leading-tight">
                  {tour.name}
                </h3>
                ...
                <div className="mt-auto flex items-center justify-between pt-8 border-t border-slate-50">
                  <div className="flex items-center gap-3 text-jvto-orange font-mono text-[10px] uppercase tracking-[0.2em] font-black">
                    <ShieldCheck className="w-4 h-4" /> Verified Route
                  </div>
                  <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center group-hover:bg-jvto-orange group-hover:text-white transition-all duration-500">
