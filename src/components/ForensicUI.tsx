...
export const HashBadge = ({ hash }: { hash: string }) => (
  <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-center gap-4 group shadow-sm">
    <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center shadow-sm group-hover:bg-safety-orange group-hover:text-white transition-all duration-500">
...
export const PillarCard = ({ 
  ...
  <div className="bg-white p-10 md:p-12 rounded-[2.5rem] border border-slate-100 shadow-sm group hover:shadow-2xl transition-all duration-700 relative overflow-hidden">
    ...
    <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mb-10 text-authority-navy group-hover:bg-safety-orange group-hover:text-white transition-all duration-500 shadow-sm">
    ...
    <button 
      onClick={onAction}
      className="w-full py-5 rounded-2xl bg-slate-50 text-authority-navy text-xs font-black uppercase tracking-[0.2em] hover:bg-safety-orange hover:text-white transition-all duration-500 flex items-center justify-center gap-3 shadow-sm"
    >
