...
import { X, ZoomIn, ZoomOut, Download, ShieldCheck, FileText, Fingerprint, Search } from 'lucide-react';
...
export const AssetViewer = ({ isOpen, onClose, assetUrl, assetTitle, assetHash, assetType }: AssetViewerProps) => {
      ...
      <div className="fixed inset-0 z-[200] flex items-center justify-center p-0 md:p-12">
        ...
        >
          ...
          <div className="p-6 md:p-8 border-b border-slate-100 flex items-center justify-between bg-white/80 backdrop-blur-md z-20">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-[8px] md:text-[10px] text-slate-400 uppercase tracking-widest truncate max-w-[150px] md:max-w-[200px]">
                    HASH: {assetHash}
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-verified-bright/10 border border-verified-bright/30 rounded-xl text-verified-bright font-mono text-[10px] font-bold uppercase tracking-widest">
          ...
          <div className="flex-1 overflow-hidden relative bg-slate-50 flex items-center justify-center p-4 md:p-8">
            ...
            <div className="absolute bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-2 md:gap-4 bg-authority-navy/90 backdrop-blur-md px-4 md:px-6 py-2 md:py-3 rounded-xl md:rounded-2xl border border-white/10 z-40">
              ...
              <span className="font-mono text-[10px] md:text-xs text-white min-w-[40px] md:min-w-[60px] text-center font-bold">{Math.round(zoom * 100)}%</span>
              ...
              <button className="flex items-center gap-2 text-white hover:text-verified-bright transition-colors font-mono text-[8px] md:text-[10px] font-bold uppercase tracking-widest">
          ...
          <div className="p-4 md:p-6 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-4 md:gap-6">
              <div className="flex flex-col">
                <span className="font-mono text-[7px] md:text-[8px] text-slate-400 uppercase tracking-widest mb-1">Audit Node</span>
                <span className="font-mono text-[9px] md:text-[10px] text-authority-navy font-bold">ID_JKT_01</span>
              </div>
              <div className="hidden sm:flex flex-col">
                <span className="font-mono text-[8px] text-slate-400 uppercase tracking-widest mb-1">Timestamp</span>
                <span className="font-mono text-[10px] text-authority-navy font-bold">{new Date().toISOString().split('T')[0]}</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="status-live"></div>
              <span className="font-mono text-[8px] md:text-[10px] text-safety-orange font-black uppercase tracking-widest">Live_Forensic_Session</span>
            </div>
          </div>
        </motion.div>
      </div>
