  ...
  return (
    <section className="py-24 bg-slate-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative p-12 md:p-20 rounded-[3rem] bg-authority-navy text-white overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-[0.85] mb-8">
              Ready to <br />
              <span className="text-safety-orange text-5xl md:text-8xl">Audit Our System?</span>
            </h2>
            <p className="text-xl md:text-2xl text-slate-300 mb-12 leading-tight font-light">
