    ...
    <section id="strategic-affiliations" className="py-24 bg-audit-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative rounded-md bg-jvto-navy text-white overflow-hidden border border-white/10 shadow-hover"
        >
          {/* Background Effects */}
          <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-jvto-orange/10 via-transparent to-blue-500/10 pointer-events-none" />
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-8 md:p-16 lg:p-20 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-white/10">
              ...
              >
                ...
                <span className="text-jvto-orange">{highlight.title.split(' ').slice(2).join(' ')}</span>
              </motion.h2>
              ...
              <motion.p
                ...
                className="text-lg md:text-xl font-light text-white/70 leading-relaxed mb-10 max-w-xl border-l-2 border-jvto-orange/30 pl-8"
              >
                {highlight.narrative}
              </motion.p>
              ...
              >
                <button 
                  ...
                  className="px-8 py-4 bg-jvto-orange hover:bg-jvto-orange/90 text-white rounded-md font-black uppercase tracking-widest transition-all shadow-card shadow-jvto-orange/20 flex items-center gap-3 group"
                >
                ...
                <div className="flex items-center gap-3 px-6 py-4 bg-white/5 rounded-md border border-white/10">
                  <ShieldCheck className="w-5 h-5 text-jvto-lime" />
            ...
            <div className="p-8 md:p-16 lg:p-20 bg-black/20 backdrop-blur-sm flex flex-col justify-center">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {highlight.partners?.map((partner: any, idx: number) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center text-center">
                      <span className="font-mono text-[10px] uppercase tracking-[0.2em] font-black text-slate-400 mb-1 group-hover/partner:text-jvto-orange transition-colors">
                        {partner.name}
                      </span>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: 0.5 }}
                  className="bg-jvto-orange/10 border border-jvto-orange/30 rounded-md p-8 flex flex-col justify-center items-center text-center gap-4 group cursor-pointer hover:bg-jvto-orange/20 transition-all"
                >
                  <Globe className="w-10 h-10 text-jvto-orange mb-2 group-hover:scale-110 transition-transform" />
              ...
              <div className="mt-12 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  <div className="h-1 w-8 bg-jvto-orange/30 rounded-full overflow-hidden">
                    <div className="h-full bg-jvto-orange w-3/4 animate-pulse" />
                  </div>
                </div>
              </div>
            </div>
